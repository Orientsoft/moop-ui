    ...
    <div className="centminheight">
      <Row justify="center" className="m-t-20">
        <Col span={labelSpan + wrapperSpan}>
          <ProjectList data={selected} showFinishedIcon={false} onStarted={onStarted} onStoped={onStoped} onMoveUp={onMoveUp} onMoveDown={onMoveDown} onDelete={onDelete} onRenderItem={onRenderItem} canDelete={false} startArgs={{ edit: true, classroom: room ? room.id : '' }} />
        </Col>
      </Row>
      <Row justify="center" className="m-t-20">
        <Col span={4}>
