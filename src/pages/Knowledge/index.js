								...
								<div className="knowledge-body">
									<div className="panes active">
										  <div className="panes-body panesinfo">
											  <div>
												  <p>&nbsp;&nbsp;&nbsp;&nbsp;请各位同学开始实验前，务必认真阅读该“实验指导书”，以便有效地完成所有实验操作。如实验中遇到困难，也请查阅该指导书。</p>
                                                  <p>&nbsp;&nbsp;&nbsp;&nbsp;本实验总成绩由三部分组成：练习成绩占30%、实验报告占20%、实验考核成绩占50%。</p>
											  </div>
											  ...
											  <h5>2.3 课堂练习</h5>
											  <p>每个notebook最后都设置了练习题，练习成绩占总成绩30%。学生需认真完成了该步骤学习后作答。所有练习记录都会上传给老师，用于统计练习情况。</p>
											  <img src="images/xssy/xssy9.jpg" />
											  <h5>2.4 实验考核</h5>
											  <p>
											    完成了所有课堂练习后，将迎来“实验考核”。内容涉及到之前的所有知识点，帮助同学们进一步巩固知识和检验学习成果。考核成绩占总成绩50%，所以建议同学们在开始考核前，将前面的notebook教学内容和练习再反复理解和操作一下，以便取得好成绩。  
											  </p>
											  <img src="images/xssy/xssy10.jpg" width="100%" />
											  <h5>2.5 提交作业和考核</h5>
											  <p>
												  在目录最后有个一个“提交”按钮，学生点击可将练习和考核信息提交给老师，注意以下两点：
                                                <p>&nbsp;&nbsp;&nbsp;1) 可重复提交。当练习和考核内容有变化时，可及时提交，将最新内容上传给老师。</p>
                                                <p>&nbsp;&nbsp;&nbsp;2) 提交前，请确认你已完成上述所有实验。如下图，课程已全部打勾（包括实验统计，可直接打勾）。</p>
											  </p>
											  ...
											  注意：<br/>
											  1) 实验报告只可提交一次；<br />
											  2) 实验报告可在未启动实验环境的情况下也可以编写；<br />
											  3) 因提交后无法修改，建议学生先打好草稿在誊抄。<br />
											  4) 实验报告成绩占总成绩的20%。
											  </p>
