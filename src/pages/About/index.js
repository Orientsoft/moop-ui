        ...
        <div className="container  text-left">
          <div className="row">
            <div className="col-12 col-md-6">
              <h2 className="large ">关于我们 K@S Lab</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container p-b-60 ">
          <div className="row">
            ...
            <div className="col-12 col-md-9">
              <h2>关于我们</h2><br />
              <p>&nbsp;&nbsp;&nbsp;&nbsp;K@S Lab数据科学开放实验室是由Jupyter China社区与北京百智享科技有限公司共同开发运营的线上数据科学实验平台。</p><br />
              ...
              <p>&nbsp;&nbsp;&nbsp;&nbsp;北京百智享科技有限公司，网址 http://jupyter.e-courses.cn，于2018年成立，是以软件开发和数据分析为主要业务的科技公司。</p><br />
            </div>
          </div>
        </div>
      </div>
